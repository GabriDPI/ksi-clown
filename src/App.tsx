...
export default function App() {
  const ctaLink = "https://forms.gle/14Kq9Z86Cc2kNMnm9";
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <ul className="space-y-3 pt-6 border-t border-gray-200/60">
            {[
              "Divertido: Risas garantizadas desde el primer minuto.",
              "Desconexión: Olvídate de los problemas diarios.",
              "Reflexión: No es risa superficial, es humor con profundidad."
            ].map((benefit, i) => (
              <motion.li 
                key={i}
        ...
        >
          <div className="aspect-[4/5] md:aspect-square rounded-3xl overflow-hidden shadow-2xl relative">
            ...
            <img 
              src={`${import.meta.env.BASE_URL}foto-sergio.png`} 
            ...
            {[
              {
                name: "María G.",
                role: "Espectadora",
                text: "Una experiencia mágica. Me reí muchísimo, pero también me hizo reflexionar. El dominio del escenario es absoluto. Totalmente recomendado.",
